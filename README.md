...
1. Simply add this in your `<head>` tag:
    ...
    ```html
    <link rel="stylesheet" href="https://raw.githubusercontent.com/Kaiserrrrrr/blossom/master/css/blossom.css" type="text/css">
    ```
...
1. Download the file:
    ...
    ```bash
    wget "https://raw.githubusercontent.com/Kaiserrrrrr/blossom/master/css/blossom.css"
    ```

    **OR** download directly:
    [blossom](https://raw.githubusercontent.com/Kaiserrrrrr/blossom/master/css/blossom.css)
